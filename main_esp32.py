...
# === ESP32-CAM stream ===
ESP32_STREAM_URL = "http://192.168.240.224:81/stream"
...
print("\U0001F7E2 PALM (CNN version) started using ESP32-CAM. Show a gesture...")
...
while cap.isOpened():
    ...
    if not results.multi_hand_landmarks:
        ...
        cv2.imshow('PALM Gesture Recognition (ESP32-CAM)', frame)
